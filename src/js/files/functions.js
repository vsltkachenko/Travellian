...
export function menuInit() {
	if (document.querySelector('.icon-menu')) {
		...
		menuCloseOutside()
		// Приховування шапки при кліку поза нею
		headerCloseOutside()
	}
}
...
function hideHeader() {
	document.querySelector('header').classList.remove('_header-show')
}
export function menuCloseOutside() {
	document.addEventListener('click', function (e) {
...
export function headerCloseOutside() {
	document.addEventListener('click', function (e) {
